...
public class HudExample extends HudElement {
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(MessyCoding.HUD_GROUP, "example", "HUD element example.", HudExample::new);
